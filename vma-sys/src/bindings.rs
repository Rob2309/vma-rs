...
pub const VMA_ALLOCATOR_CREATE_EXTERNALLY_SYNCHRONIZED_BIT: VmaAllocatorCreateFlagBits = 1;
...
pub const VMA_ALLOCATOR_CREATE_KHR_DEDICATED_ALLOCATION_BIT: VmaAllocatorCreateFlagBits = 2;
...
pub const VMA_ALLOCATOR_CREATE_KHR_BIND_MEMORY2_BIT: VmaAllocatorCreateFlagBits = 4;
#[doc = "Enables usage of VK_EXT_memory_budget extension.\n\nYou may set this flag only if you found out that this device extension is supported,\nyou enabled it while creating Vulkan device passed as VmaAllocatorCreateInfo::device,\nand you want it to be used internally by this library, along with another instance extension\nVK_KHR_get_physical_device_properties2, which is required by it (or Vulkan 1.1, where this extension is promoted).\n\nThe extension provides query for current memory usage and budget, which will probably\nbe more accurate than an estimation used by the library otherwise."]
pub const VMA_ALLOCATOR_CREATE_EXT_MEMORY_BUDGET_BIT: VmaAllocatorCreateFlagBits = 8;
...
pub const VMA_ALLOCATOR_CREATE_AMD_DEVICE_COHERENT_MEMORY_BIT: VmaAllocatorCreateFlagBits = 16;
...
pub const VMA_ALLOCATOR_CREATE_BUFFER_DEVICE_ADDRESS_BIT: VmaAllocatorCreateFlagBits = 32;
...
pub const VMA_ALLOCATOR_CREATE_EXT_MEMORY_PRIORITY_BIT: VmaAllocatorCreateFlagBits = 64;
#[doc = "Enables usage of VK_EXT_memory_priority extension in the library.\n\nYou may set this flag only if you found available and enabled this device extension,\nalong with `VkPhysicalDeviceMemoryPriorityFeaturesEXT::memoryPriority == VK_TRUE`,\nwhile creating Vulkan device passed as VmaAllocatorCreateInfo::device.\n\nWhen this flag is used, VmaAllocationCreateInfo::priority and VmaPoolCreateInfo::priority\nare used to set priorities of allocated Vulkan memory. Without it, these variables are ignored.\n\nA priority must be a floating-point value between 0 and 1, indicating the priority of the allocation relative to other memory allocations.\nLarger values are higher priority. The granularity of the priorities is implementation-dependent.\nIt is automatically passed to every call to `vkAllocateMemory` done by the library using structure `VkMemoryPriorityAllocateInfoEXT`.\nThe value to be used for default priority is 0.5.\nFor more details, see the documentation of the VK_EXT_memory_priority extension."]
pub const VMA_ALLOCATOR_CREATE_FLAG_BITS_MAX_ENUM: VmaAllocatorCreateFlagBits = 2147483647;
...
pub const VMA_MEMORY_USAGE_CPU_COPY: VmaMemoryUsage = 5;
...
pub const VMA_MEMORY_USAGE_GPU_LAZILY_ALLOCATED: VmaMemoryUsage = 6;
...
pub const VMA_ALLOCATION_CREATE_DEDICATED_MEMORY_BIT: VmaAllocationCreateFlagBits = 1;
...
pub const VMA_ALLOCATION_CREATE_NEVER_ALLOCATE_BIT: VmaAllocationCreateFlagBits = 2;
...
pub const VMA_ALLOCATION_CREATE_MAPPED_BIT: VmaAllocationCreateFlagBits = 4;
...
pub const VMA_ALLOCATION_CREATE_USER_DATA_COPY_STRING_BIT: VmaAllocationCreateFlagBits = 32;
#[doc = " Allocation will be created from upper stack in a double stack pool.\n\nThis flag is only allowed for custom pools created with #VMA_POOL_CREATE_LINEAR_ALGORITHM_BIT flag."]
pub const VMA_ALLOCATION_CREATE_UPPER_ADDRESS_BIT: VmaAllocationCreateFlagBits = 64;
...
pub const VMA_ALLOCATION_CREATE_DONT_BIND_BIT: VmaAllocationCreateFlagBits = 128;
#[doc = " Create allocation only if additional device memory required for it, if any, won't exceed\nmemory budget. Otherwise return `VK_ERROR_OUT_OF_DEVICE_MEMORY`."]
pub const VMA_ALLOCATION_CREATE_WITHIN_BUDGET_BIT: VmaAllocationCreateFlagBits = 256;
...
pub const VMA_ALLOCATION_CREATE_CAN_ALIAS_BIT: VmaAllocationCreateFlagBits = 512;
...
pub const VMA_ALLOCATION_CREATE_HOST_ACCESS_SEQUENTIAL_WRITE_BIT: VmaAllocationCreateFlagBits =
    1024;
#[doc = "Requests possibility to map the allocation (using vmaMapMemory() or #VMA_ALLOCATION_CREATE_MAPPED_BIT).\n\n- If you use #VMA_MEMORY_USAGE_AUTO or other `VMA_MEMORY_USAGE_AUTO*` value,\nyou must use this flag to be able to map the allocation. Otherwise, mapping is incorrect.\n- If you use other value of #VmaMemoryUsage, this flag is ignored and mapping is always possible in memory types that are `HOST_VISIBLE`.\nThis includes allocations created in \\ref custom_memory_pools.\n\nDeclares that mapped memory can be read, written, and accessed in random order,\nso a `HOST_CACHED` memory type is required."]
pub const VMA_ALLOCATION_CREATE_HOST_ACCESS_RANDOM_BIT: VmaAllocationCreateFlagBits = 2048;
...
pub const VMA_ALLOCATION_CREATE_HOST_ACCESS_ALLOW_TRANSFER_INSTEAD_BIT:
    VmaAllocationCreateFlagBits = 4096;
#[doc = " Allocation strategy that chooses smallest possible free range for the allocation\nto minimize memory usage and fragmentation, possibly at the expense of allocation time."]
pub const VMA_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT: VmaAllocationCreateFlagBits = 65536;
#[doc = " Allocation strategy that chooses first suitable free range for the allocation -\nnot necessarily in terms of the smallest offset but the one that is easiest and fastest to find\nto minimize allocation time, possibly at the expense of allocation quality."]
pub const VMA_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT: VmaAllocationCreateFlagBits = 131072;
...
pub const VMA_ALLOCATION_CREATE_STRATEGY_MIN_OFFSET_BIT: VmaAllocationCreateFlagBits = 262144;
#[doc = " Alias to #VMA_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT."]
pub const VMA_ALLOCATION_CREATE_STRATEGY_BEST_FIT_BIT: VmaAllocationCreateFlagBits = 65536;
#[doc = " Alias to #VMA_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT."]
pub const VMA_ALLOCATION_CREATE_STRATEGY_FIRST_FIT_BIT: VmaAllocationCreateFlagBits = 131072;
#[doc = " A bit mask to extract only `STRATEGY` bits from entire set of flags."]
pub const VMA_ALLOCATION_CREATE_STRATEGY_MASK: VmaAllocationCreateFlagBits = 458752;
#[doc = " A bit mask to extract only `STRATEGY` bits from entire set of flags."]
pub const VMA_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM: VmaAllocationCreateFlagBits = 2147483647;
...
pub const VMA_POOL_CREATE_IGNORE_BUFFER_IMAGE_GRANULARITY_BIT: VmaPoolCreateFlagBits = 2;
...
pub const VMA_POOL_CREATE_LINEAR_ALGORITHM_BIT: VmaPoolCreateFlagBits = 4;
#[doc = " Bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VMA_POOL_CREATE_ALGORITHM_MASK: VmaPoolCreateFlagBits = 4;
#[doc = " Bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VMA_POOL_CREATE_FLAG_BITS_MAX_ENUM: VmaPoolCreateFlagBits = 2147483647;
...
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_FAST_BIT: VmaDefragmentationFlagBits = 1;
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_BALANCED_BIT: VmaDefragmentationFlagBits = 2;
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_FULL_BIT: VmaDefragmentationFlagBits = 4;
...
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_EXTENSIVE_BIT: VmaDefragmentationFlagBits = 8;
#[doc = " A bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_MASK: VmaDefragmentationFlagBits = 15;
#[doc = " A bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VMA_DEFRAGMENTATION_FLAG_BITS_MAX_ENUM: VmaDefragmentationFlagBits = 2147483647;
...
pub const VMA_DEFRAGMENTATION_MOVE_OPERATION_COPY: VmaDefragmentationMoveOperation = 0;
...
pub const VMA_DEFRAGMENTATION_MOVE_OPERATION_IGNORE: VmaDefragmentationMoveOperation = 1;
...
pub const VMA_DEFRAGMENTATION_MOVE_OPERATION_DESTROY: VmaDefragmentationMoveOperation = 2;
...
pub const VMA_VIRTUAL_BLOCK_CREATE_LINEAR_ALGORITHM_BIT: VmaVirtualBlockCreateFlagBits = 1;
#[doc = " \\brief Bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VMA_VIRTUAL_BLOCK_CREATE_ALGORITHM_MASK: VmaVirtualBlockCreateFlagBits = 1;
#[doc = " \\brief Bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VMA_VIRTUAL_BLOCK_CREATE_FLAG_BITS_MAX_ENUM: VmaVirtualBlockCreateFlagBits = 2147483647;
...
pub const VMA_VIRTUAL_ALLOCATION_CREATE_UPPER_ADDRESS_BIT: VmaVirtualAllocationCreateFlagBits = 64;
#[doc = " \\brief Allocation strategy that tries to minimize memory usage."]
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT:
    VmaVirtualAllocationCreateFlagBits = 65536;
#[doc = " \\brief Allocation strategy that tries to minimize allocation time."]
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT: VmaVirtualAllocationCreateFlagBits =
    131072;
#[doc = " Allocation strategy that chooses always the lowest offset in available space.\nThis is not the most efficient strategy but achieves highly packed data."]
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_OFFSET_BIT:
    VmaVirtualAllocationCreateFlagBits = 262144;
#[doc = " \\brief A bit mask to extract only `STRATEGY` bits from entire set of flags.\n\nThese strategy flags are binary compatible with equivalent flags in #VmaAllocationCreateFlagBits."]
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MASK: VmaVirtualAllocationCreateFlagBits = 458752;
#[doc = " \\brief A bit mask to extract only `STRATEGY` bits from entire set of flags.\n\nThese strategy flags are binary compatible with equivalent flags in #VmaAllocationCreateFlagBits."]
pub const VMA_VIRTUAL_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM: VmaVirtualAllocationCreateFlagBits =
    2147483647;
